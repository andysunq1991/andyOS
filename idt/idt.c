...
static void idt_set_gate(uint8_t num, uint32_t base, uint16_t sel, uint8_t flags);	//设置中断描述符

extern void idt_flush(uint32_t);	//声明加载IDTR的函数

void init_idt()						//初始化中断描述符表
{
